...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, GPIO_PIN_11|GPIO_PIN_12|GPIO_PIN_13|PC_EN_Pin
  ...
  /*Configure GPIO pins : PC11 PC12 PC13 PCPin
                           PCPin PCPin PC10 */
  GPIO_InitStruct.Pin = GPIO_PIN_11|GPIO_PIN_12|GPIO_PIN_13|PC_EN_Pin
                          |AIR_M_EN_Pin|AIR_P_EN_Pin|GPIO_PIN_10;
  ...
  GPIO_InitStruct.Pin = CHARGER_FLAG_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(CHARGER_FLAG_GPIO_Port, &GPIO_InitStruct);
